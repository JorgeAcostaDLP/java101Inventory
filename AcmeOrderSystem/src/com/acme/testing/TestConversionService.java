...
//		short grams =  ConversionService.grams(new BigDecimal("30")));
//		byte byteGrams = (byte)ConversionService.grams(new BigDecimal("30")));
...
//		short s = 30;
//		System.out.println(ConversionService.grams(new BigDecimal(String(s))));
//		byte b = 4;
